...
import ru.netology.form.CreditForm;
import ru.netology.form.PaymentForm;
...
public class SqlHelper {
    ...
    public static String getPaymentApprovedStatus() {
        ...
        try (Connection connection = getConnection()) {
            var result = runner.query(connection, codeSQL, new BeanHandler<>(PaymentForm.class));
    ...
    public static String getCreditApprovedStatus() {
        ...
        try (Connection connection = getConnection()) {
            var result = runner.query(connection, codeSQL, new BeanHandler<>(CreditForm.class));
            return result.getStatus();
        } catch (SQLException sqlException) {
            sqlException.printStackTrace();
        }
